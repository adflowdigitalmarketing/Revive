...
import { Snowflake, Wind, Leaf, MapPin, Linkedin, ExternalLink } from "lucide-react";
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 text-center py-32">
          ...
          >
            ...
            <p className="text-2xl md:text-3xl text-white/90 mb-6 max-w-4xl mx-auto">
              Sustainable Development for the North
            </p>
            <p className="text-lg md:text-xl text-white/80 mb-12 max-w-3xl mx-auto leading-relaxed">
              Innovative solutions for Denmark and Scandinavia. Combining Irish durability with Scandinavian ambition for zero emissions.
            </p>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                {[
                  { label: "Sales Support", icon: "🛒" },
                  { label: "Service Center", icon: "🔧" },
                  { label: "Rental Fleet", icon: "📦" }
                ].map((item, idx) => (
                  <div key={idx} className="bg-white/10 backdrop-blur-md border border-white/20 p-6 rounded-[16px]">
